...
# -------------------------------------------------------------------------------------------#
    ...
    REQUEST_URI = 'https://{}/authorize?audience={}&response_type={}&client_id={}&redirect_uri={}'.format(AUTH0_DOMAIN, AUTH0_AUDIENCE, AUTH0_RESPONSE_TYPE, AUTH0_CLIENT_ID, AUTH0_REDIRECT)  # noqa
